...
public class FeedImageVO {
	...
	private String feed_search; // 메인 게시글 검색
	 ...
	 * @param feed_search 메인 게시글 검색
	 */
	public FeedImageVO(String fi_no, String fi_path, String fi_file, String feed_no, String feed_search) {
		this.fi_no = fi_no;
		this.fi_path = fi_path;
		this.fi_file = fi_file;
		this.feed_no = feed_no;
		this.feed_search = feed_search;
	}
	...
	public String getFeed_search() {
		return feed_search;
	}

	public void setFeed_search(String feed_search) {
		this.feed_search = feed_search;
	}
	...
	public String toString() {
		return "FeedImageVO [fi_no=" + fi_no + ", fi_path=" + fi_path + ", fi_file=" + fi_file + ", feed_no=" + feed_no
				+ ", feed_search=" + feed_search + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
