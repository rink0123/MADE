...
public class MemberVO {
	...
	private String pagesize;      // 한 페이지에 보여질 게시물의 수
	...
	public MemberVO(String bm_no, String bm_id, String bm_pw, String bm_img, String bm_nick, String bm_name,
			...
			String bm_updatedate, String bm_deletedate, String pagesize, String curpage, String totalpage) {
		this.bm_no = bm_no;
		this.bm_id = bm_id;
		this.bm_pw = bm_pw;
		this.bm_img = bm_img;
	...
	public String toString() {
		return "MemberVO [bm_no=" + bm_no + ", bm_id=" + bm_id + ", bm_pw=" + bm_pw + ", bm_img=" + bm_img
				...
				+ ", bm_updatedate=" + bm_updatedate + ", bm_deletedate=" + bm_deletedate + ", pagesize=" + pagesize
				+ ", curpage=" + curpage + ", totalpage=" + totalpage + ", getClass()=" + getClass() + ", hashCode()="
